...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'werknemer') {
    // If they aren't logged in as a werknemer, kick them out or handle it safely
...
<body>
    ...
    <div class="container">
        <h1>Inloggen in het CRM-Systeem als: Werknemer</h1><br>
